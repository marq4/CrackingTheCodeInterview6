...
from linked_list import LinkedList, linked_lists_are_identical
...
def test_single():
    ...
    assert linked_lists_are_identical( single_ll, LinkedList( [56] ) )
...
def test_no_duplicates():
    ...
    assert linked_lists_are_identical( should_not_change_ll, \
        LinkedList( [10, 20, 30] ) )
...
def test_basic_middle():
    ...
    assert linked_lists_are_identical( middle_ll, LinkedList( [1, 2, 3] ) )
...
def test_intermediate_first_last():
    ...
    assert linked_lists_are_identical( first_last_ll, LinkedList( [0, 22, 33] ) )
...
def test_advanced_many_duplicates():
    ...
    assert linked_lists_are_identical( many_ll, LinkedList( [-6, 0, -8] ) )
...
def test_all_duplicates():
    ...
    assert len(all_ll) == 1
    assert linked_lists_are_identical( all_ll, LinkedList( [4] ) )
